...
const { getHistoric, create, update, destroyOne, destroyMany, } = messageController;
router.route('/')
    .post(validateSchema(createMessage, canals.body), factory(create))
    .patch(validateSchema(updateMessage, canals.body), validateSchema(updateMessage, canals.body), factory(update));
router.route('/:id')
